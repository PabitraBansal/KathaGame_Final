...
public class wordSearch_goat extends Activity implements View.OnClickListener {
    ...
    public static final String TAG = "wordSearch_goat";
    private View prev;
    public String soln[];
    private ArrayList<Button> clicked_btns = new ArrayList<>();
    private int horizontal_check;
    private int check;
    private int num_solns = 3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_word_search_goat);
        soln = new String[3];
        soln[0] = "हसीना";
        soln[1] = "पक्षीराज";
        soln[2] = "बकरी";
        ...
        if(btnCounter==0){
            ...
            if(Math.abs(prev.getId()-v.getId())==1) {
                ...
                if(horizontal_check==1) {
                    ...
                    if(check==num_solns){
                        Intent intent = new Intent(wordSearch_goat.this, endscreen_goat.class);
